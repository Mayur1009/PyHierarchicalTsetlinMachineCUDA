...
tm = MultiClassTsetlinMachine(10, 15, 2.5, number_of_state_bits=8, boost_true_positive_feedback=0, hierarchy_structure=((tm.AND_GROUP, number_of_values), (tm.AND_GROUP, 2), (tm.OR_ALTERNATIVES, number_of_values**number_of_addends*10), (tm.AND_GROUP, 1)))
