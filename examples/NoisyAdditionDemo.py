...
tm = MultiClassTsetlinMachine(200, 160, 20.1, number_of_state_bits=8, boost_true_positive_feedback=1, hierarchy_structure=((tm.AND_GROUP, 10), (tm.AND_GROUP, 2), (tm.OR_ALTERNATIVES, 20), (tm.AND_GROUP, 1)))
