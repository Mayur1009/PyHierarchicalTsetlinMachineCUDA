...
tm = TsetlinMachine(clauses, T, s, number_of_state_bits=8, boost_true_positive_feedback=0, hierarchy_structure=((tm.AND_GROUP, 3), (tm.OR_ALTERNATIVES, 4), (tm.AND_GROUP, 2), (tm.OR_ALTERNATIVES, 4), (tm.AND_GROUP, 2)))
